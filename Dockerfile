...
RUN julia -e 'using Pkg;Pkg.add(["Turing","CSV","DataFrames","Plots", "StatsPlots", "LogExpFunctions", "Colors", "StatsModelComparisons", "Distributions","Statistics","RDatasets","ForneyLab","RxInfer"]);Pkg.precompile()'
WORKDIR "${HOME}"