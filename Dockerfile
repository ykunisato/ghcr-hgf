...
RUN julia -e 'using Pkg;Pkg.add(["Turing","CSV","DataFrames","Plots","ArviZ", "StatsPlots","Suppressor", "LogExpFunctions", "Colors", "StatsModelComparisons", "Distributions","Statistics","RDatasets","ForneyLab","RxInfer","BenchmarkTools"]);Pkg.precompile()'
WORKDIR "${HOME}"